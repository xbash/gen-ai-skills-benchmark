...
| `docs/RUBRIC.md` | Contrato de evaluación | No leído por los scripts actuales | `judge.py` contiene su propia rúbrica; `CONTEXT.md` lo llama contrato legible de Q | Hacer auditable la escala humana de calidad | MANTENER | Divergencia entre la rúbrica documentada y la constante de `judge.py` | Mantener como referencia; revisar y sincronizar si la Q sigue siendo parte del flujo |
